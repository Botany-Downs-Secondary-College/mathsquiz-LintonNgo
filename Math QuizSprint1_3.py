class MathsQuiz: 
 def init (self,parent): 
  ...
  self.Welcome.grid(row=0, column=O) 
  ...
  self.QuestionsLabel = Label(self.Questions, text = "Quiz Questions", bg = "black", fg = "white", width = 20, padx = 30, pady = 10, font = ("Time", '19', "bold italic")) 
